...
if __name__ == '__main__':
    ...
    def run(iteration, start_time, device=0):
        ...
        early_stop_callback = EarlyStopping(monitor="GCN_val_loss", patience=50, mode="min")
        trainer = Trainer(
        ...
        early_stop_callback = EarlyStopping(monitor="GIN_val_loss", patience=50, mode="min")
        trainer = Trainer(
            max_steps=args.steps,
            callbacks=[early_stop_callback],
            logger=logger,
